<section class="contact">
    <div class="container-fluid mt-0">
        <div class="row">
            <div class="col-lg-5 col-12 contact-info-container d-flex justify-content-end flex-column">
                <?php if(!empty(get_field('address_cn','option'))){ ?>
                <ul data-aos="fade-right" class="contact-info pl-0 list-unstyled">
                    <?php the_field('address_cn','option'); ?>
                </ul>
                <?php } ?>
                <ul data-aos="fade-right" data-aos-delay="100" class="contact-data pl-0 list-unstyled">
                    <?php if(!empty(get_field('phone_cn','option'))){ ?>
                    <li><?php the_field('phone_cn','option'); ?></li>
                    <?php } if(!empty(get_field('email_cn','option'))){ ?>
                    <li><?php the_field('email_cn','option'); ?></li>
                    <?php } ?>
                </ul>
                <ul class="social-media d-flex pl-0 list-unstyled">
                    <?php if(!empty(get_field('facebook','option'))){ ?>
                    <li data-aos="fade-right" data-aos-delay="150">
                        <a target="_blank" class="square-icon" href="<?php the_field('facebook','option'); ?>">
                    ...
                    <li data-aos="fade-right" data-aos-delay="200">
                        <a target="_blank" class="square-icon" href="<?php the_field('instagram','option'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                    ...
                    <li data-aos="fade-right" data-aos-delay="250">
                        <a target="_blank" class="square-icon" href="<?php the_field('linkedin','option'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
            ...
            <div class="col-lg-7 col-12 contact-form">
                <h1 class="hero-text" data-aos="fade-left"><?php the_field('form_heading_cn','option'); ?></h1>
                <div class="form row">
                    <?php echo do_shortcode(get_field('form_shortcode_cn','option')); ?>
                </div>
            </div>
        </div>
    </div>
